...
@NamedEntityGraph(name = "Movie.withTagsAndManagers", attributeNodes = {
        @NamedAttributeNode("tags"),
        @NamedAttributeNode("managers")})
@NamedEntityGraph(name = "Movie.withZonesAndManagers", attributeNodes = {
        @NamedAttributeNode("zones"),
        @NamedAttributeNode("managers")})
@NamedEntityGraph(name = "Movie.withManagers", attributeNodes = {
        @NamedAttributeNode("managers")})
@NamedEntityGraph(name = "Movie.withMembers", attributeNodes = {
        @NamedAttributeNode("members")})
@NamedEntityGraph(name = "Movie.withTagsAndZones", attributeNodes = {
        @NamedAttributeNode("tags"),
        @NamedAttributeNode("zones")})
@Entity
...
public class Movie {
    ...
    public void close() {
        if (this.published && !this.closed) {
            ...
            throw new RuntimeException("모임 종료할 수 없습니다. 모임을 공개하지 않았거나 이미 종료한 모임입니다.");
        }
    }
