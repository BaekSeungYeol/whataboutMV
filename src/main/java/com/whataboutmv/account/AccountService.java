...
import com.whataboutmv.config.AppProperties;
import com.whataboutmv.domain.Account;
import com.whataboutmv.domain.Tag;
import com.whataboutmv.domain.Zone;
import com.whataboutmv.mail.EmailMessage;
import com.whataboutmv.mail.EmailService;
...
public class AccountService implements UserDetailsService {
    ...
    public void sendSignUpConfirmEmail(Account newAccount) {
        ...
        context.setVariable("message", "영화어때 서비스를 사용하려면 링크를 클릭하세요.");
    ...
    public void sendLoginLink(Account account) {
        ...
        context.setVariable("linkName", "영화어때 로그인하기");
